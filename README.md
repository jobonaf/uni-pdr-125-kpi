...
- **Verifica automatica** dei KPI obbligatori ("necessari") per fascia
...
1. Selezionare la **fascia dimensionale** dell'organizzazione (1–4)
2. **Compilare i KPI** secondo le indicazioni
3. Verificare il **raggiungimento della soglia** di certificazione (60%)
4. **Generare report** e esportare i dati

## Accessibilità

Lo strumento è sviluppato con attenzione alle **Linee Guida AGID sull'accessibilità** (WCAG 2.1 livello AA) per l'utilizzo da parte di operatori della Pubblica Amministrazione.
